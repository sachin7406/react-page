...
const Marquee1 = () => {
  ...
  useEffect(() => {
    ...
    marqueeTween.current = gsap.to(marqueeElements.current, {
      ...
      modifiers: {
        x: (x) => {
          return (parseFloat(x) % (screenWidth * 0.8)) + "px";
        }
      }
    });
  }, [screenWidth]);
  ...
  return (
    <div
      className=" line-text relative w-screen mt-8 py-4 bg-green-600 text-gray-200 flex overflow-hidden items-center"
